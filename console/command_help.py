...
CONVERSATIONAL_ENTRIES = (
    ...
    HelpEntry("cambiar usuario", "Cambia el perfil activo en la consola.", "Usuarios", ("cambiar usuario a REDACTED_bc04a68d9192",), ("sesion", "perfil")),
    HelpEntry("quién soy", "Indica el perfil autenticado y el interlocutor actual.", "Usuarios", ("quién soy",), ("identidad", "perfil")),
    HelpEntry("generar código telegram", "Genera un código temporal para vincular una cuenta.", "Telegram", ("generar código telegram para REDACTED_342ad0893cb2",), ("vincular", "enlazar", "cuenta", "madre"), detail="Primero genera el código para el perfil. Después, desde la cuenta que se va a vincular, envía la frase de confirmación."),
    HelpEntry("confirmar código telegram", "Vincula la cuenta de Telegram al perfil indicado.", "Telegram", ("Confirma el código de Telegram 483291 para REDACTED_342ad0893cb2",), ("confirmar", "vincular", "enlazar")),

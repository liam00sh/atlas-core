...
ATLAS_HOME_LOCATION y, de forma provisional para este proyecto, usa REDACTED_a77d7bb7adbf.
...
class AtlasDailyBriefMixin:
    ...
    def _handle_daily_brief(self, text: str) -> bool:
        ...
        location = os.environ.get("ATLAS_HOME_LOCATION", "REDACTED_a77d7bb7adbf, REDACTED_4cde1bf18b9c, España").strip()

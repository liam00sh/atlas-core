...
def _change_to_declared_user(user: str) -> str:
    ...
    interlocutores, aunque el usuario escriba expresiones como «soy REDACTED_0f38c2ded26f».
    """
...
def detect(text: str) -> str | None:
    ...
    #     "Hola, soy REDACTED_bc04a68d9192" -> "hola soy REDACTED_7b9528898599"
    text = normalize_text(text)

    # -------------------------------------------------------------------------
    # CAMBIO DE USUARIO: "soy REDACTED_bc04a68d9192"
    # -------------------------------------------------------------------------
    ...
    # Ejemplo:
    #
    #     "soy REDACTED_7b9528898599".startswith("soy ")
    #
    # devuelve True.
    if text.startswith("soy "):
        ...
        # Ejemplo:
        #
        #     "soy REDACTED_7b9528898599"
        #          ↓
        #     "REDACTED_7b9528898599"
        #
        # title() coloca la primera letra en mayúscula:
        #
        #     "REDACTED_7b9528898599" -> "REDACTED_bc04a68d9192"
    ...
    # -------------------------------------------------------------------------
    # CAMBIO DE USUARIO: "me llamo REDACTED_bc04a68d9192"
    # -------------------------------------------------------------------------
    ...
    # -------------------------------------------------------------------------
    # CAMBIO DE USUARIO: "hola, soy REDACTED_bc04a68d9192"
    # -------------------------------------------------------------------------
    #
    # normalize_text() elimina la coma, por lo que la expresión queda:
    #
    #     "hola soy REDACTED_7b9528898599"
    #
